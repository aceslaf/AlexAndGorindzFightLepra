           ...
           <ul class="nav navbar-nav navbar-right bigmenu">
              ...
              <li class="dropdown">
                 ...
                 <ul class="dropdown-menu">
                    <li><a href="aboutus1.php">Јазици</a></li>
                    <li><a href="aboutus2.php">Нашите преводи</a></li>
                    <li><a href="aboutus3.php">Преведувачите</a></li>
                 </ul>
              </li>
              <li><a href="services.php" >Услуги</a></li>
              <li><a href="galery.php" style="background-image:none">Фотки</a></li>
                 <li><a href="contact.php" style="background-color: rgb(165,182,42) !important; background-image:none;">Контакт</a></li>
           ...
           <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                 <ul class="nav navbar-nav navbar-right">
                    <li><a href="index.php" class="activelink">Почетна</a></li>
                    ...
                    <li><a href="services.php">Услуги</a></li>
                    <li><a href="galery.php">Фотки</a></li>
                    <li><a href="contact.php" style="background-color: rgb(165,182,42) !important; background-image:none;">Контакт</a></li>
                 </ul>
              </div>
              <!-- /.navbar-collapse -->
